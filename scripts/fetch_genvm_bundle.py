...
# `inspect` for the modules imported below. Take the folder off the path.
...
# contracts/statelock.py's `Depends` header; "whatever is latest" is not a
    ...
    for asset in ASSETS:
        ...
        try:
            request = urllib.request.Request(
                url, headers={"User-Agent": "statelock-ci"})
